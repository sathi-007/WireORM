...
import com.mast.android.orm.js2p.CommentaryList;
import com.mast.android.orm.js2p.OverSeparator;
...
//    }
    ...
    public  List<CommentaryList> getMockMastCommentaryList(int count){
        List<CommentaryList> commentaryList = new ArrayList<>();
        for(int i=0;i<count;i++){
            commentaryList.add(getMockMastCommentary(i));
        }
        return commentaryList;
    }

    public CommentaryList getMockMastCommentary(int index){
        CommentaryList commentaryList = new CommentaryList();
        commentaryList.setCommText("commText "+index);
        commentaryList.setEvent("No Event");
        commentaryList.setInningsId(index);
    ...
    public OverSeparator getMockOverSeperator(){
        OverSeparator overSeparator = new OverSeparator();
